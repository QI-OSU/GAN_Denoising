...
class vgg16(torch.nn.Module):
    def __init__(self, requires_grad=False, pretrained=True, weight_path=None):
        ...
        vgg_pretrained = torchvision.models.vgg16(pretrained=False)
        vgg_pretrained.load_state_dict(torch.load(weight_path))
...
class LPIPS(nn.Module):
    def __init__(self, net='vgg', version='0.1', weight_path=None, use_dropout=True):
        ...
        self.net = vgg16(pretrained=False, requires_grad=False, weight_path=weight_path)
